...
LgameProper::LgameProper() {
}

// --- Main Game Logic ---
void LgameProper::run(Music& fightMusic) {
    srand(time(0));
    VideoMode desktop = VideoMode::getDesktopMode();
    int W = desktop.width;
    int H = desktop.height;
    RenderWindow app(desktop, "Land Element", Style::Fullscreen);
    ...
    t2.loadFromFile("images/earthBG.jpg");
    t3.loadFromFile("images/explosions/type_C.png");
    t4.loadFromFile("images/meteors/yellow.png");
    t5.loadFromFile("images/bulletbrown.png");
