...
WgameProper::WgameProper() {
}

// --- Main Game Logic ---
void WgameProper::run(Music& fightMusic) {
    srand(time(0));
    VideoMode desktop = VideoMode::getDesktopMode();
    int W = desktop.width;
    int H = desktop.height;
    RenderWindow app(desktop, "Water Element", Style::Fullscreen);
    ...
    if (!fireBuffer.loadFromFile("imagesmusic/fire.wav")) {
    ...
    t2.loadFromFile("images/waterBG.jpg");
    t3.loadFromFile("images/explosions/type_C.png");
    t4.loadFromFile("images/meteors/yellow.png");
    t5.loadFromFile("images/bulletgreen.png");
